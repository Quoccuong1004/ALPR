...
yolov6_model = my_yolov6("weights/yolo_license_plate.pt", "cpu", "data/mydataset.yaml", 640, True)
...
def home_page():
    ...
    if request.method == "POST":
        ...
        ndet = 0  # Define and assign an initial value to `ndet`
        return render_template('index.html', ndet=ndet)
